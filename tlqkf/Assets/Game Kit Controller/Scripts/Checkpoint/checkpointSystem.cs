...
public class checkpointSystem : MonoBehaviour
{
	...
	public void addNewCheckpoint ()
	{
		...
		newWayPoint.name = "Checkpoint " + (checkPointList.Count + 1).ToString ();
		...
		newCheckpointElement.setCheckPointManager (GetComponent<checkpointSystem> ());
	...
	{
		#if UNITY_EDITOR
		EditorUtility.SetDirty (GetComponent<checkpointSystem> ());
		#endif
	}

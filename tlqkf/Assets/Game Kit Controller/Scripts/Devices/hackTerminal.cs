...
public class hackTerminal : MonoBehaviour
{
	...
	public void setCurrentPlayer ()
	{
		...
		cameraMovementManager.setCurrentPlayer (electronicDeviceGameObject.GetComponent<electronicDevice> ().getCurrentPlayer ());
	}
	...
	{
		if (showGizmo) {
			if (content && hackTerminalTargetTransform) {

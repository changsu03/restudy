...
public class waypointPlayerPathSystem : MonoBehaviour
{
	...
	{
		audioSource = currentUser.GetComponent<playerStatesManager> ().getAudioSourceElement ("Timer Audio Source");

		gameInfoHudManager = currentUser.GetComponent<playerInputManager> ().getPauseManager ().getGameInfoHudManager ();

...
{
	public bool plataformActive = true;
	...
	void Start ()
	{
		...
		inversePath.Reverse ();
		if (!stopIfPlayerOutSide && !useJustToMovePlatform && plataformActive) {
	...
	void OnTriggerEnter (Collider col)
	{
		...
		} else if (col.gameObject.tag == vehicleTag) {
			//store him

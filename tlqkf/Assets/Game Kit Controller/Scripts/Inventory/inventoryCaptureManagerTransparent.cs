...
public class inventoryCaptureManagerTransparent : MonoBehaviour
{
	...
	[MenuItem ("Game Kit Controller/Go To Capture Inventory Transparent Icon Manager Scene")]
	static void openInventoryCaptureManager ()
	{
		EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo ();
		EditorSceneManager.OpenScene ("Assets//Game Kit Controller/Scenes/Inventory Icon Creator/Create Inventory Transparent Icon.unity");
	}
